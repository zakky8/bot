...
ANT.FUN (May 2026): next-generation Social DEX with ultra-low-rate trading + AI intelligent trading tools. Tagline: "Trade Fast, Own True". Partnership combines Astarter's AI-native DeFAI infrastructure and autonomous AI Agent execution with ANT.FUN's social DEX — creating a more intelligent, efficient and social-attributed on-chain trading and pledge ecosystem. Theme: "Launch · Meets · Social Trading". https://ant.fun | https://x.com/ant_fun_trade

BEHAVIOUR:
• Vague question ("partners", "partnerships") → "Astarter has 7 active partners: MULAN Labs, PayGo, Zeus Network, ENI/ENIAC, UXLINK, SumPlus, and ANT.FUN." Ask which one they want details on.
...
Partners: MULAN https://mulan.meme · PayGo https://www.paygo.ac · Zeus https://zeusnetwork.xyz · ENI https://eniac.network · UXLINK https://x.com/UXLINKofficial | https://uxlink.io | https://linktr.ee/uxlink_official · SumPlus https://www.sumplus.xyz · ANT.FUN https://ant.fun | https://x.com/ant_fun_trade
...
const INTENT_KEYWORDS: Record<string, string[]> = {
  ...
  partnerships: ['partner','paygo','zeus network','eni','eniac','mulan labs','zbtc','bitcoin','x402','uxlink','sumplus','mcp','defi data','ant.fun','ant fun','ant_fun','social dex','ant fun trade'],
